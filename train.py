...
def main(args=None):
    ...
    for epoch_num in range(parser.epochs):
        ...
        torch.save(retinanet.module, '../results/retinanet_outputs/{}_retinanet_{}.pt'.format(parser.dataset, epoch_num))

    retinanet.eval()

    torch.save(retinanet, '../results/retinanet_outputs/model_final.pt')
